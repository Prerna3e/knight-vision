...
export function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#0f0f0f] flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#d4a843]/10 blur-[100px] rounded-full pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-purple-900/10 blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 text-center">
        ...
        <p className="mt-2 text-center text-sm text-gray-400 font-medium">
          Or{' '}
          <Link to="/register" className="font-bold text-[#d4a843] hover:text-[#e5bf5e] transition-colors underline decoration-transparent hover:decoration-[#e5bf5e]">
